...
| `textDocument/documentLink`                                | Transclusion targets (`::file`, `::code`, `::url`, `prologue`, `epilogue`, `::toc-linking`); standard markdown links/images (delegated to base markdown logic).                                                                                  | Provide both target URI and a tooltip showing transclusion options (`when=`, `exclude=`, etc.).                                                                                                                                                                                                                                                                                                  |
