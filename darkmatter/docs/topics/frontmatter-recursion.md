...
When we talk about "state" during the [**Compose**](./what-is-composition.md) based Markdown pipelining operations it refers to an abstraction of a Markdown page's "frontmatter". 
