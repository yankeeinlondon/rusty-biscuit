...
feature: page-blocks
base_dir: /Volumes/coding/personal/rusty-biscuit/darkmatter/features/page-blocks
---
# Feature

## Context on Feature Building

We are in the process of building out the "page-blocks" feature. Building a feature consists of the following discrete steps:
...
- now that we've finished the implementation of the plan for the "page-blocks" feature we need to stage and commit the files which we have modified in the implementation
