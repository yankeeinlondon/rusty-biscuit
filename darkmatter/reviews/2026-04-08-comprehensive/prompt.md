You are performing a **senior-level Rust code review** on the **darkmatter** package area (library and CLI).
...
Now perform the review and save the results to darkmatter/reviews/2026-04-08-comprehensive/review.md 
