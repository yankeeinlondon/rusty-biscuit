...
fn parse_tailwind(raw: &str) -> Result<Option<StyleColor>, &'static str> {
    ...
    if let Some(special) = parse_tailwind_special(color_part) {
        return Ok(Some(StyleColor {
            color: Color::Tailwind(special),
            opacity,
        }));
    }
...
mod tests {
    ...
    fn tailwind_specials() {
        ...
        assert_eq!(
            parse("black").unwrap().color,
            Color::Tailwind(Tailwind::Black)
        );
        assert_eq!(
            parse("white").unwrap().color,
            Color::Tailwind(Tailwind::White)
        );
    }
        ...
        &[
            ...
            (
                ...
                [
                    ...
                    Orange700, Orange800, Orange900, Orange950,
                ],
            ),
            (
                "amber",
                [
                    Amber50, Amber100, Amber200, Amber300, Amber400, Amber500, Amber600, Amber700,
                    Amber800, Amber900, Amber950,
                ],
            ),
            (
                "yellow",
                [
                    ...
                    Yellow700, Yellow800, Yellow900, Yellow950,
                ],
            ),
            (
                "lime",
                [
                    Lime50, Lime100, Lime200, Lime300, Lime400, Lime500, Lime600, Lime700, Lime800,
                    Lime900, Lime950,
                ],
            ),
            (
                "green",
                [
                    Green50, Green100, Green200, Green300, Green400, Green500, Green600, Green700,
                    Green800, Green900, Green950,
                ],
            ),
            (
                "emerald",
            ...
            (
                "teal",
                [
                    Teal50, Teal100, Teal200, Teal300, Teal400, Teal500, Teal600, Teal700, Teal800,
                    Teal900, Teal950,
                ],
            ),
            (
                "cyan",
                [
                    Cyan50, Cyan100, Cyan200, Cyan300, Cyan400, Cyan500, Cyan600, Cyan700, Cyan800,
                    Cyan900, Cyan950,
                ],
            ),
            (
            ...
            (
                "blue",
                [
                    Blue50, Blue100, Blue200, Blue300, Blue400, Blue500, Blue600, Blue700, Blue800,
                    Blue900, Blue950,
                ],
            ),
            (
                ...
                [
                    ...
                    Indigo700, Indigo800, Indigo900, Indigo950,
                ],
            ),
            (
                "violet",
                [
                    Violet50, Violet100, Violet200, Violet300, Violet400, Violet500, Violet600,
                    Violet700, Violet800, Violet900, Violet950,
                ],
            ),
            (
                "purple",
                [
                    ...
                    Purple700, Purple800, Purple900, Purple950,
                ],
            ),
            (
                "fuchsia",
            ...
            (
                "pink",
                [
                    Pink50, Pink100, Pink200, Pink300, Pink400, Pink500, Pink600, Pink700, Pink800,
                    Pink900, Pink950,
                ],
            ),
            (
                "rose",
                [
                    Rose50, Rose100, Rose200, Rose300, Rose400, Rose500, Rose600, Rose700, Rose800,
                    Rose900, Rose950,
                ],
            ),
            (
                "slate",
                [
                    Slate50, Slate100, Slate200, Slate300, Slate400, Slate500, Slate600, Slate700,
                    Slate800, Slate900, Slate950,
                ],
            ),
            (
                "gray",
            ...
            (
                "zinc",
                [
                    Zinc50, Zinc100, Zinc200, Zinc300, Zinc400, Zinc500, Zinc600, Zinc700, Zinc800,
                    Zinc900, Zinc950,
                ],
            ),
            (
            ...
            (
                "stone",
                [
                    Stone50, Stone100, Stone200, Stone300, Stone400, Stone500, Stone600, Stone700,
                    Stone800, Stone900, Stone950,
                ],
            ),
        ]
    };
