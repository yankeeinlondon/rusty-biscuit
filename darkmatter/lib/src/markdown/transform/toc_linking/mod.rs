...
//! referenced files.
//!
//! This is a Stage 1 (Preparation) transform that runs between interpolation
...
use crate::markdown::transform::transclusion::resolve_path;
...
///
/// Returns the transformed content and the number of directives expanded.
...
mod tests {
    ...
    fn stage_toggle_disabled() {
        ...
        let (result, report) = md.transform_with(options).unwrap();
