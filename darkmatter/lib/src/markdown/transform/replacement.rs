//! Text replacement engine for the transform pipeline.
//!
...
//!
//! ```
//! use darkmatter::markdown::transform::{EffectiveState, EffectiveStateBuilder};
//! use darkmatter::markdown::transform::replacement::apply_replacements;
//! use serde_json::json;
...
///
/// Returns the transformed content and the number of replacements made.
///
/// ## Rules
///
