...
pub struct TransformOptions {
    ...
    /// When true, the cleanup stage removes blank lines between list items
    /// instead of preserving/adding them (compact list output).
...
impl std::fmt::Debug for TransformOptions {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("TransformOptions")
            ...
            .field("compact_lists", &self.compact_lists)
...
impl TransformOptions {
    ...
    /// Enables compact list mode in the cleanup stage.
    ///
    /// When enabled, blank lines between list items in loose lists are removed
    /// instead of being preserved.
    #[must_use]
    pub fn with_compact_lists(mut self, compact: bool) -> Self {
