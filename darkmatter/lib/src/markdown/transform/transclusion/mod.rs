...
//! formatting helpers used by the transform pipeline's Stage 2 transclusion
//! engine.
...
pub use resolver::{is_url_like, normalize_reference_token, resolve_path, resolve_target};
pub use types::{
