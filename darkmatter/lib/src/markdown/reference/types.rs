...
pub struct ReferenceGraphOptions {
    ...
    /// Whether to include TOC links generated by `::toc-linking`.
    ///
    /// **Not yet implemented.** Reserved for future use. When enabled,
    /// generated table-of-contents links will appear as reference records
    /// in graph and composed views.
    pub include_generated_toc_links: bool,
    /// Whether to follow `::url` remote transclusions.
    ///
    /// **Not yet implemented.** Reserved for future use. When enabled,
    /// `::url` directives will be fetched and their references included
...
impl Default for ReferenceGraphOptions {
    fn default() -> Self {
        Self {
            ...
            include_generated_toc_links: false,
            follow_remote_transclusions: false,
        }
    }
}
