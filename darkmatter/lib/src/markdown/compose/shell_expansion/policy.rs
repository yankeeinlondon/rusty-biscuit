...
///
/// ```
/// use darkmatter::markdown::compose::shell_expansion::policy::check_builtin_blacklist;
///
...
///
/// ```
/// use darkmatter::markdown::compose::shell_expansion::policy::{check_user_blacklist, normalize_command};
/// use darkmatter::markdown::compose::shell_expansion::types::{ShellRuleSet, ShellRuleEntry};
///
...
///
/// ```
/// use darkmatter::markdown::compose::shell_expansion::policy::{check_whitelist, normalize_command};
/// use darkmatter::markdown::compose::shell_expansion::types::{ShellRuleSet, ShellRuleEntry};
///
/// let mut ruleset = ShellRuleSet::default();
...
mod tests {
    use super::*;
    use crate::markdown::compose::shell_expansion::types::ShellRuleEntry;
