...
const KNOWN_DRIFT: &[(&str, &str, Facet)] = &[
    ...
    ("YamlBlock", "align_right", Facet::Width),
    ...
    ("YamlBlock", "row_fill_fill", Facet::Exact),
    ("YamlBlock", "row_fill_fill", Facet::Text),
    ("YamlBlock", "row_fill_fill", Facet::Indent),
    ("YamlBlock", "row_fill_fill", Facet::Width),
    ("YamlBlock", "row_fill_fill", Facet::Styling),
