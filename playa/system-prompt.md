...
- you are working in the **Playa** package area inside the **rusty-biscuit** monorepo
- you should use the 'playa' agent skill
- the Playa library and CLI are intended to work on macOS, Linux, and Windows

## Best Practices

- when working with the playa CLI use the 'cli' agent skill
