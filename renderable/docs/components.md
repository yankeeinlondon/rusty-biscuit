...
| TwoColumn       | Block  | ✅       | ❌      | ❌       | ✅   | both avail, old renders      | bespoke       | `biscuit-terminal/lib/src/components/two_column.rs`          | A responsive two-column layout that stacks vertically when narrow.                  |
