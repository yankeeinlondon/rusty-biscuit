...
/// anywhere a [`Color`](crate::color::Color) is accepted, enabling consistent
/// theming across terminal applications.
///
/// ## Examples
///
/// ```
/// use renderable::color::{Color, WebColor};
///
