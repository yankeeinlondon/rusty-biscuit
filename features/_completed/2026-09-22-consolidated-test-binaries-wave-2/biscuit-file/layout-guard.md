# Layout gate red/green — `biscuit-file`

Command: `cargo nextest run -p biscuit-file --test l1 every_test_source_is_compiled_by_a_declared_target`
...
```text
        FAIL [   0.028s] (1/1) biscuit-file::l1 test_layout::every_test_source_is_compiled_by_a_declared_target
    test test_layout::every_test_source_is_compiled_by_a_declared_target ... FAILED
    test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 139 filtered out; finished in 0.02s
    ...
    tests/stray.rs: a top-level test file is never compiled; move it into a declared target's directory and declare it in that target's main.rs
     Summary [   0.028s] 1 test run: 0 passed, 1 failed, 139 skipped
        FAIL [   0.028s] (1/1) biscuit-file::l1 test_layout::every_test_source_is_compiled_by_a_declared_target
```
...
```text
        PASS [   0.028s] (1/1) biscuit-file::l1 test_layout::every_test_source_is_compiled_by_a_declared_target
     Summary [   0.028s] 1 test run: 1 passed, 139 skipped
```
