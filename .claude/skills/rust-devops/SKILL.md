...
hash: 81b1157379fa2909-805324abab61883c
...
- [gitoxide](./gitoxide.md) — pure-Rust Git via the `gix` facade: the `gix` (library) vs `gitoxide` (CLI) version split, the `Repository` hub, feature-flag and caching model, the same per-operation use cases, and where it outruns (or still trails) `git2`.