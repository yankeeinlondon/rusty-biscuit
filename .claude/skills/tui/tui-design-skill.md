...
For Unicode character reference tables and border style gallery, see [visual-catalog.md](./resources/visual-catalog.md).
For real-world TUI app design analysis and inspiration, see [app-patterns.md](./resources/app-patterns.md).
