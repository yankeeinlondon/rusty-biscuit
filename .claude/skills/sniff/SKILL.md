...
| `GitRepo` | Primary `gix::Repository` handle from trusted discovery; retains a transitional `git2::Repository` for unported phases. Basic accessors (root, HEAD, branch, worktree flags) are gix-backed. |
