...
hash: 65dc854540ca152c-a8b9ac173a6161a0
---
...
[`claudine/docs/research/summary/`](../../../claudine/docs/research/summary/) and published here via `just publish-summary-research`
...
(`$schema: ./_schema.yaml`). Live topics under [`claudine/docs/research/`](../../../claudine/docs/research/):

- [`agent-logging/`](../../../claudine/docs/research/agent-logging/) — log surfaces, per-site time semantics (unit/zone), record types
- [`agent-models/`](../../../claudine/docs/research/agent-models/) — out-of-box models, selection mechanisms, precedence, dynamic listing
- [`agent-permissions/`](../../../claudine/docs/research/agent-permissions/) — permission CLI params, config files, YOLO, PolicyEngine fit
- [`agent-errors/`](../../../claudine/docs/research/agent-errors/) — ordered structured-stream error vocabularies with
  per-needle provenance; generation projects these research records into
  [`lib/src/stream/providers/vocabulary.rs`](../../../claudine/lib/src/stream/providers/vocabulary.rs). Immutable Phase-A baselines under
  [`agent-errors/_seeds/`](../../../claudine/docs/research/agent-errors/_seeds/) let the deterministic gate detect removals, re-kinds,
...
- [`model-config/`](../../../claudine/docs/research/model-config/) — user-side model extension (cloud + local) across all 9 roster
  ...
  [`model-config-refresh.md`](../../../claudine/features/_completed/2026-07-02-provider-metadata/model-config-refresh.md)). For
...
- [`local_runners/`](../../../claudine/docs/research/local_runners/) — the runner-side counterpart to `model-config`: local model
  ...
  traps. Roster: [`claudine/docs/local-runners.yaml`](../../../claudine/docs/local-runners.yaml); spike notes:
  [`spike-local-runners.md`](../../../claudine/features/_completed/2026-07-02-provider-metadata/spike-local-runners.md). For
  runner-specific depth, prefer the **local-runners** skill (distilled tables); the
  research docs remain the source of truth.
- [`agent-cli/`](../../../claudine/docs/research/agent-cli/), [`non-interactive-sessions/`](../../../claudine/docs/research/non-interactive-sessions/), [`usage/`](../../../claudine/docs/research/usage/) — earlier topics; sidecars
...
in [`claudine/features/_completed/2026-07-02-provider-metadata/spec.md`](../../../claudine/features/_completed/2026-07-02-provider-metadata/spec.md) and its spike findings. New topics
