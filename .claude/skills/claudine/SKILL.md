...
Publication-only library/CLI tests share
`claudine/test-support/locked_audio_spool.rs` to remove pending work before
releasing the scheduler lock, including unwinding. See
`claudine/docs/topics/testing.md` for the fixture boundaries.
