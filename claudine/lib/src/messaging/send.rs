...
mod tests {
    ...
    fn execute_notification_blank_is_noop() {
        // Calling outside any tokio runtime — if the function reached
        // `tokio::spawn`, it would panic. The empty-title early return keeps
        // the call site safe and synchronous.
