You are performing a **senior-level Rust code review** on the **claudine** package area (library and CLI).
...
6. **Concurrency / async**
   - If applicable, review async code, shared state, locking, Send/Sync assumptions, task cancellation, back-pressure, and blocking work inside async contexts.
...
Now perform the review and save the results to claudine/reviews/2026-04-17-comprehensive/review.md 
