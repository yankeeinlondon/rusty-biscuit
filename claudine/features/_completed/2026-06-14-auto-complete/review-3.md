...
Coverage present: Level 1 unit tests verify `gather_candidates(..., ComposeMode::Sequence)` includes YAML sequence files and verify `extract_yaml_sequence_detail` reads YAML top-level keys. The new Level 2 operation-file tests stage only Markdown `compose` prompts ([level2_auto_complete_operation_file.rs](../../cli/tests/level2_auto_complete_operation_file.rs:65), [level2_auto_complete_operation_file.rs](../../cli/tests/level2_auto_complete_operation_file.rs:353), [level2_auto_complete_operation_file.rs](../../cli/tests/level2_auto_complete_operation_file.rs:392)), and the new Level 3 operation-file tests also drive only `claudine compose --goose plan` with Markdown prompt files ([level3_auto_complete_operation_file.rs](../../cli/tests/level3_auto_complete_operation_file.rs:61), [level3_auto_complete_operation_file.rs](../../cli/tests/level3_auto_complete_operation_file.rs:283), [level3_auto_complete_operation_file.rs](../../cli/tests/level3_auto_complete_operation_file.rs:437)).
