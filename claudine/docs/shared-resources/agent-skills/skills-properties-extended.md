...
We do research on every supported CLI agent and you'll find the detailed results on their support for Agent Skills in @claudine/docs/research/skills (_one file per agent_) but here are some properties you may have run into in the past to help you understand what's out there in the wild:
