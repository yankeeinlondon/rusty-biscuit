...
prompt: |-
    ...
    - you are very knowledgeable about technology in general 
    ...
    - your task is do a deep dive into the "best practices" for agent definitions **specifically** for the **{{state.desc}}** agentic CLI
    - 
...
Agentic CLI's all have the concept of being able to provide a "prompt" that defines the identity for a specific agent. On most platforms
this is stored as a
