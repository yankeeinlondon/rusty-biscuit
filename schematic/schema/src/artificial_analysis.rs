...
impl ArtificialAnalysisData {
    ...
    /// ```
    #[must_use]
    pub fn variant(&self) -> ArtificialAnalysisDataVariantBuilder<'_> {
        ArtificialAnalysisDataVariantBuilder::new(self)
    }
...
impl Default for ArtificialAnalysisData {
    fn default() -> Self {
        Self::new()
    }
}
...
/// the variant client.
pub struct ArtificialAnalysisDataVariantBuilder<'a> {
    base: &'a ArtificialAnalysisData,
...
impl<'a> ArtificialAnalysisDataVariantBuilder<'a> {
    /// Creates a new variant builder from the base API client.
    fn new(base: &'a ArtificialAnalysisData) -> Self {
        Self {
            base,
            base_url: None,
            env_auth: None,
    ...
    #[must_use]
    pub fn build(self) -> ArtificialAnalysisData {
...
impl ArtificialAnalysisData {
    ...
    async fn build_and_send_request(
        &self,
        request: impl Into<ArtificialAnalysisDataRequest>,
...
impl ArtificialAnalysisCritPt {
    ...
    /// ```
    #[must_use]
    pub fn variant(&self) -> ArtificialAnalysisCritPtVariantBuilder<'_> {
        ArtificialAnalysisCritPtVariantBuilder::new(self)
    }
    /// Creates a variant of this API client with different configuration.
    ///
    /// This is a convenience method equivalent to:
...
impl Default for ArtificialAnalysisCritPt {
    fn default() -> Self {
        Self::new()
    }
}
...
/// configuration methods and call [`build()`](Self::build) to create
/// the variant client.
pub struct ArtificialAnalysisCritPtVariantBuilder<'a> {
    base: &'a ArtificialAnalysisCritPt,
    base_url: Option<String>,
    env_auth: Option<Vec<String>>,
    auth_update: schematic_define::UpdateStrategy,
    headers: Option<schematic_define::Headers>,
...
impl<'a> ArtificialAnalysisCritPtVariantBuilder<'a> {
    /// Creates a new variant builder from the base API client.
    fn new(base: &'a ArtificialAnalysisCritPt) -> Self {
        Self {
            base,
            base_url: None,
            env_auth: None,
    ...
    /// Options not explicitly set will inherit from the base client.
    #[must_use]
    pub fn build(self) -> ArtificialAnalysisCritPt {
        let auth_update = self.auth_update.clone();
        let auth_policy = match auth_update.clone() {
            schematic_define::UpdateStrategy::NoChange => self.base.auth_policy.clone(),
            schematic_define::UpdateStrategy::ChangeTo(ref auth) => {
...
impl ArtificialAnalysisCritPt {
    ...
    async fn build_and_send_request(
        &self,
        request: impl Into<ArtificialAnalysisCritPtRequest>,
    ) -> Result<(reqwest::Response, crate::shared::ResponseContext), SchematicError> {
        let request = request.into();
        let endpoint_id = request.endpoint_id();
        let (method, path, body, endpoint_headers) = request.into_parts()?;
