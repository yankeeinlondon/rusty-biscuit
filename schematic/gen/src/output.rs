...
pub fn assemble_api_module(api: &RestApi) -> TokenStream {
    ...
    let api_name_lower = api_name.to_lowercase();
...
pub fn assemble_prelude(apis: &[&RestApi]) -> TokenStream {
    ...
    // Generate re-exports for each API
    let api_reexports: Vec<_> = apis
        ...
        .map(|api| {
            ...
            quote! {
                pub use crate::#module_name::{#client_name, #request_enum, SchematicError};
            }
        })
        .collect();
...
mod tests {
    ...
    fn generate_and_write_file_contains_formatted_code() {
        ...
        // Check lib.rs exists and has module declaration
