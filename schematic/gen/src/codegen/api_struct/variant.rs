//! Variant builder generation for API client structs.

use proc_macro2::{Ident, TokenStream};
use quote::quote;

/// Generates variant-related methods on the API struct impl block.
///
/// Produces:
...
/// Generates the VariantBuilder struct definition and its impl block.
///
