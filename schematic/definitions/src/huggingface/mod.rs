    ...
    RestApi {
        ...
        endpoints: vec![
            ...
            Endpoint {
                ...
                request: None,
                response: ApiResponse::json_vec_type("DatasetInfo"),
                headers: vec![],
                    params: None,
                    oauth_scopes: None,
            },
            ...
            Endpoint {
                ...
                request: None,
                response: ApiResponse::json_vec_type("SpaceInfo"),
                headers: vec![],
                    params: None,
                    oauth_scopes: None,
            },
            ...
            Endpoint {
                ...
                request: None,
                response: ApiResponse::json_vec_type("RepoInfo"),
                headers: vec![],
                    params: None,
                    oauth_scopes: None,
            },
            Endpoint {
                ...
                request: None,
                response: ApiResponse::json_vec_type("Collection"),
                headers: vec![],
                    params: None,
                    oauth_scopes: None,
            },
