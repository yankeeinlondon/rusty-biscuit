...
Constraint `value` is the quoted string "2000". md ACCEPTS it: default-on coercion turns numeric strings into numbers (no strict-types flag). Rust serde into an integer must reject it (SR-STRICT-SCALARS).
