...
interfaces:
  ...
  - { interface_id: discord.gateway, role: research_only, api_identity: Gateway, classification: official, direction: receive_only, adapters: [discord] }
api_versions: []
chronology: []
constraints:
  - id: c.a
...
Rule SR-ROSTER: a research-only interface claims an adapter. Schema accepts; Rust must reject.
