...
role_coverage: []
envelopes:
  - { id: env.a, interface: discord.bot, operations: [create_message], origin: service, body_format: json, code_locator: error_code, knowledge: { state: known, evidence: [src.a] } }
errors: []
error_fixtures: []
capabilities: []
inbound_bindings: []
...
Envelope locator is neither a JSON Pointer nor a known locator form. Expected: rejected by pattern.
