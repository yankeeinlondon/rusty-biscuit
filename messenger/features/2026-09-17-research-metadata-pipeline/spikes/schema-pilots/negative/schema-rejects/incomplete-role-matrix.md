...
role_coverage:
  - interface: discord.bot
    roles:
      inline_content: { state: unknown, bindings: [] }
      attachment: { state: unknown, bindings: [] }
      primary: { state: unknown, bindings: [] }
      thumbnail: { state: unknown, bindings: [] }
      accessory: { state: unknown, bindings: [] }
      author_icon: { state: unknown, bindings: [] }
      footer_icon: { state: unknown, bindings: [] }
envelopes: []
errors: []
error_fixtures: []
capabilities: []
...
Role matrix omits `link_preview`. Expected: rejected (every canonical role is a required key).
