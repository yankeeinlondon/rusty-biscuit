---
# An unknown bridge error with a drafted, non-executable candidate signature.
# Criterion 13. Expect: valid.
...
- id: env.fx.jsonrpc
  ...
  knowledge:
    ...
    - src.fx.docs
errors:
- id: err.fx.unknown_rpc
  interface: signal_cli_jsonrpc
  operations:
  - send
  envelope: env.fx.jsonrpc
  origin: bridge
  phase: response
  outcome: failure
  category: unknown
  candidate_match:
    native_code_number: -32603
  ...
  knowledge:
    ...
    evidence: []
    gap: gap.fx.scope
    explanation: Drafted signature only; never executable while unknown.
error_fixtures: []
inbound_bindings: []
question_bindings: []
form_bindings: []
