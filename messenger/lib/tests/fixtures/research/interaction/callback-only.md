---
# A research-only callback companion that receives interactions but no
# arbitrary conversation text; callbacks never imply text reception.
# Criterion 20. Expect: valid.
...
- id: ib.fx.callback
  ...
  authentication: Ed25519 signature headers
  ack_deadline_ms: 3000
  payload:
    sender: /member/user/id
