---
# Measurement unit `unicode_scalars` at stage `field_value`. Counted as Unicode scalar values.
...
- id: c.fx.unicode_scalars
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: Counted as Unicode scalar values.
format_profiles: []
text_bindings: []
image_bindings: []
role_coverage: []
