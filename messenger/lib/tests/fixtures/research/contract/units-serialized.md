---
# Measurement unit `utf8_bytes` at stage `serialized_payload`. Measured on JSON-escaped bytes: a newline costs 2.
...
- id: c.fx.serialized
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: 'Measured on JSON-escaped bytes: a newline costs 2.'
format_profiles: []
text_bindings: []
image_bindings: []
role_coverage: []
