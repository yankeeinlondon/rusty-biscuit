---
# Stable versus preview provider API versions, an SDK release kept apart from
# the provider API, a month-precision date, and an unknown release date.
# Criterion 25. Expect: valid.
...
- id: chr.fx.api.v11
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: Only the month is documented.
- id: chr.fx.api.v9
  interface: discord_bot_api
  subject: provider_api
  version: v9
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: Release date not established; the retrieval date is not a release date.
- id: chr.fx.sdk.0_17
  interface: discord_bot_api
  subject: sdk
  name: twilight-http
