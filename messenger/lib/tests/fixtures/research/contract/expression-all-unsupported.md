---
# An all-unsupported expression result backed by evidence is valid; no
# invented effect or fallback is needed. Criterion 19. Expect: valid.
...
- id: ex.fx.none
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: No message-effect field exists for this operation.
delivery_controls: []
eligibility: []
rate_limits: []
envelopes: []
