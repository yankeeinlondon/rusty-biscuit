---
# Request and per-file byte limits with an account-tier condition. Criterion 4. Expect: valid.
...
chronology: []
constraints:
- id: c.fx.request.bytes
  interface: discord_bot_api
  operation: create_message
  surface: request_payload
  native_locator: multipart body
