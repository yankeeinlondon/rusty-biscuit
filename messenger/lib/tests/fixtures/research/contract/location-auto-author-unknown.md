---
# An automatically included author/device location shape whose truth is
# unknown, and an unknown author-geolocation answer. Unknown origins stay
# explicit. Criterion 18. Expect: valid.
...
- id: loc.fx.device
  interface: signal_cli_jsonrpc
  operation: send
  role: author_location
  subject: device
  mode: static
  association: platform_asserted
  origin: device_derived
  inclusion: always
