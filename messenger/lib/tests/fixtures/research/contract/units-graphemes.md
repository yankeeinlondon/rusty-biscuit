---
# Measurement unit `grapheme_clusters` at stage `field_value`. Counted as extended grapheme clusters; e + U+0301 counts 1.
# Criterion 5: units, combining sequences, and parsed text versus encoded markup
# are distinct values. Expect: valid.
...
- id: c.fx.graphemes
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: Counted as extended grapheme clusters; e + U+0301 counts 1.
format_profiles: []
text_bindings: []
image_bindings: []
role_coverage: []
