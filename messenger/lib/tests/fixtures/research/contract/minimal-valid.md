---
# Smallest valid platform document: one interface, empty category arrays,
# and a complete coverage matrix whose cells all point at one investigated gap.
# Criteria: 2, 3, 28 (an empty array is never coverage by itself). Expect: valid.
