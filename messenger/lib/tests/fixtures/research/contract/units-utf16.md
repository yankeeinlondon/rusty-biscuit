---
# Measurement unit `utf16_code_units` at stage `field_value`. Counted as UTF-16 code units; a non-BMP emoji counts 2.
...
- id: c.fx.utf16
  ...
  knowledge:
    ...
    evidence:
    - src.fx.docs
    explanation: Counted as UTF-16 code units; a non-BMP emoji counts 2.
format_profiles: []
text_bindings: []
image_bindings: []
role_coverage: []
