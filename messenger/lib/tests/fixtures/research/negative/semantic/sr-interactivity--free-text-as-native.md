---
# Free-text interpretation claimed as a native structured reply (criterion 21).
# Schema-valid by design; the Rust rule rejects it.
# expect-rule: SR-INTERACTIVITY
...
- id: qb.fx
  ...
  kind: confirmation
  native: native
  mechanism: free_text_interpretation
  operation: create_message
  native_locator: components
  answer_type: boolean
