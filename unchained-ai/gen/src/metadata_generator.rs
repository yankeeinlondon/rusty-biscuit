...
use unchained_ai::models::model_metadata::{ModelModalities, Modality, ProviderModelMetadata};
...
impl MetadataGenerator {
    ...
    pub fn generate_openrouter(&self) -> String {
        ...
        code.push_str("//!\n");
        code.push_str(
            "//! Contains rich metadata for OpenRouter models including pricing,\n",
        );
        code.push_str(
...
mod tests {
    ...
    fn test_merge_native_only() {
        ...
        let result =
            MetadataGenerator::merge_metadata(Some(native), None);
    ...
    fn test_merge_native_wins_over_parsera() {
        ...
        let result =
            MetadataGenerator::merge_metadata(Some(native), Some(&parsera));
        let merged = result.unwrap();
