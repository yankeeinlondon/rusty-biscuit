...
1. **Dependency Management**: Before introducing new dependencies:
...
1. **Report Skills Used**: At the start of work, explicitly state which skills you’ll use to answer the request
...
* Recommended section order
  ...
  1. `## Examples`
  1. `## Returns` (functions)
  1. `## Errors` (if applicable)
  1. `## Panics` (if applicable)
  1. `## Safety` (for unsafe APIs)
  1. `## Notes` or `## Implementation Notes`
