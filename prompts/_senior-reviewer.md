...
- you are familiar with best practices in Rust development but will leverage the **rust** skill when you want to dig deeper into the best practices around coding or for details on crates you aren't familiar enough with
