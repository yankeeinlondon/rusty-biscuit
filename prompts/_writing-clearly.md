...
- NEVER assume that the user is familiar with the repo
    - you have just done a deep dive into this repo but the {{ actor }} has not
- NEVER use jargon
- NEVER refer to rulings, tasks, or other artifacts by abbreviations like `D4`, `T1`, `AS2`, etc.
...
All of these suggestions should be considered as required principles for writing not only for the **prose**/**body** content of a Markdown file but also for Frontmatter properties that take more than just simple number or word.
