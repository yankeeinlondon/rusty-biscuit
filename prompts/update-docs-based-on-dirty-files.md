...
You will concurrently pass one document to each subagent and tell them to update their assigned document to address any detected of "drift" (aka, the documentation no longer accurately reflecting the state of the source code).
