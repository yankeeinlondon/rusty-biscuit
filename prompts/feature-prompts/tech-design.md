...
- You must have a subagent execute the following steps:
    - Reviewer
        ...
        - create a detailed tech design and save it to @{{area}}/features/{{feature}}/tech-design.md
    - Finalization
        - review the tech design file at @{{area}}/features/{{feature}}/tech-design.md
    ...
    - Summarization
        - provide a summarization of the tech-design at @{{area}}/features/{{feature}}/tech-design.md
