...
- Review the @homelab/README.md @homelab/cli/README.md @homelab/lib/README.md @homelab/gen/README.md for documentation context on the homelab package
...
- Now create (or update if it already exists) a Claude Code skill for "homelab" locally in @.claude/skills .
