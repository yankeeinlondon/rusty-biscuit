...
- Review the @tree-hugger/README.md @tree-hugger/cli/README.md @tree-hugger/lib/README.md for documentation context on the tree-hugger package
...
- Now create (or update if it already exists) a Claude Code skill for "tree-hugger" locally in @.claude/skills .
