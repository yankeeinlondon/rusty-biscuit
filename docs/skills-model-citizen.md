...
- Review the @model-citizen/README.md @model-citizen/cli/README.md @model-citizen/lib/README.md @model-citizen/gen/README.md for documentation context on the model-citizen package
...
- Now create (or update if it already exists) a Claude Code skill for "model-citizen" locally in @.claude/skills .
...
- you should always use the `rust` and `clap` skills
