...
- Review the @schematic/README.md @schematic/define/README.md @schematic/gen/README.md
@schematic/definitions/README.md @schematic/schema/README.md for documentation context,
...
- Now create (or update if it already exists) a Claude Code skill for "schematic" locally in @.claude/skills .
