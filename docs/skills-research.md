...
- Review the @research/README.md @research/cli/README.md @research/lib/README.md for documentation context on the research package
...
- Now create (or update if it already exists) a Claude Code skill for "research" locally in @.claude/skills .
