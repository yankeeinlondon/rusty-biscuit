...
- Review the @sniff/README.md @sniff/cli/README.md @sniff/lib/README.md for documentation context on the sniff package
...
- Now create (or update if it already exists) a Claude Code skill for "sniff" locally in @.claude/skills .
