...
- Review the @queue/README.md @queue/cli/README.md @queue/lib/README.md for documentation context on the queue package
...
- Now create (or update if it already exists) a Claude Code skill for "queue" locally in @.claude/skills .
