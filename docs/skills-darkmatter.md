...
- Review the @darkmatter/README.md @darkmatter/cli/README.md @darkmatter/lib/README.md for documentation context on the Darkmatter package
...
- Now create (or update if it already exists) a Claude Code skill for "darkmatter" locally in @.claude/skills .
