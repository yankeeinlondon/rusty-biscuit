...
- Review the @claudine/README.md @claudine/cli/README.md @claudine/lib/README.md @claudine/gen/README.md for documentation context on the claudine package
...
- Now create (or update if it already exists) a Claude Code skill for "claudine" locally in @.claude/skills .
