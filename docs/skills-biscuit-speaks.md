...
- Review the @biscuit-speaks/README.md for documentation context on the biscuit-speaks package
...
- Now create (or update if it already exists) a Claude Code skill for "biscuit-speaks" locally in @.claude/skills .
