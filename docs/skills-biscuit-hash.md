...
- Review the @biscuit-hash/README.md @biscuit-hash/cli/README.md @biscuit-hash/lib/README.md for documentation context on the biscuit-hash package
...
- Now create (or update if it already exists) a Claude Code skill for "biscuit-hash" locally in @.claude/skills .
