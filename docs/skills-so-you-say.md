...
- Review the @so-you-say/README.md for documentation context on the so-you-say package
...
- Now create (or update if it already exists) a Claude Code skill for "so-you-say" locally in @.claude/skills .
