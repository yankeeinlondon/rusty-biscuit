...
**Phases Completed:**
- Phase 1: Core Types and Error Handling - Complete (28 tests)
- Phase 2: Voice Builder Pattern - Complete
- Phase 3: Core Speech Functions - Complete
- Phase 4: Remove Deprecated Functions and Update Callers - Complete

**Files Modified:**
- `shared/src/tts.rs` - Refactored with new types and API
- `shared/Cargo.toml` - (already had thiserror)
- `so-you-say/src/main.rs` - Updated to use `speak_when_able()`
- `research/lib/src/main.rs` - Updated to use `speak_when_able()`
- `research/cli/src/main.rs` - Updated to use `speak_when_able()`, removed local function
- `research/cli/Cargo.toml` - Added shared dependency, removed tts dependency
