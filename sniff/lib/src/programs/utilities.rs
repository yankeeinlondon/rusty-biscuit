...
impl InstalledUtilities {
    ...
    pub fn new() -> Self {
        let programs = [
            "exa", "eza", "rg", "ripgrep", "dust", "bat", "batcat", "fd", "fdfind", "procs", "btm",
            "bottom", "fzf", "zoxide", "starship", "direnv", "jq", "delta", "tldr", "tealdeer",
            "lazygit", "gh", "htop", "btop", "tmux", "zellij", "http", "https", "httpie", "curlie",
            "mise", "hyperfine", "tokei", "xh", "xhs", "curl", "wget", "iperf3",
        ];
