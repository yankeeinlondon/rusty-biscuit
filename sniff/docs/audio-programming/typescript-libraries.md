...
prompt: |-
    ...
    The final deliverable is a idiomatic Markdown document. All code examples should be written in modern Typescript. If you feel a Mermaid diagram would help illustrate an idea, please feel free to include that too.
