...
```bash
sniff repo unstaged-package-areas -p sniff-cli            # The area sniff-cli lives in (when unstaged)
sniff repo unstaged-package-areas --package-area homelab  # Unstaged homelab/* areas
```
