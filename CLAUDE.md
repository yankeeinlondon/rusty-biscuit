...
This project is indexed by GitNexus as **rusty-biscuit** (129797 symbols, 256371 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
This project is indexed by GitNexus as **rusty-biscuit** (130583 symbols, 259528 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
